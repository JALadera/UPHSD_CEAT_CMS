        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-card p-6 border border-gray-100">
                    ...
                    <div class="space-y-2">
                        <a href="{{ route('departments.index') ?? '#' }}" class="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-maroon-200 hover:bg-maroon-50/30 transition-all duration-300 group">
                            <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('programs.index') ?? '#' }}" class="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-maroon-200 hover:bg-maroon-50/30 transition-all duration-300 group">
                            <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('faculty.index') ?? '#' }}" class="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-maroon-200 hover:bg-maroon-50/30 transition-all duration-300 group">
                            <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('news.index') ?? '#' }}" class="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-maroon-200 hover:bg-maroon-50/30 transition-all duration-300 group">
                            <div class="flex items-center gap-3">
                ...
                <div class="bg-white rounded-2xl shadow-card p-6 border border-gray-100">
                    ...
                    <div class="space-y-2">
                        <a href="{{ route('students.index') ?? '#' }}" class="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-maroon-200 hover:bg-maroon-50/30 transition-all duration-300 group">
                            <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('research.index') ?? '#' }}" class="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-maroon-200 hover:bg-maroon-50/30 transition-all duration-300 group">
                            <div class="flex items-center gap-3">
                                <span class="w-8 h-8 bg-amber-100 rounded-lg flex items-center justify-center text-sm">🔬</span>
                                <span class="font-medium text-gray-900 group-hover:text-maroon-600 transition-colors">Manage Research</span>
                            </div>
                            <svg class="w-5 h-5 text-gray-300 group-hover:text-maroon-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                        </a>
